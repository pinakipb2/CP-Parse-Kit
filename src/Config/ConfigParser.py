        ...
        if "required" in self.config_file_data:
            for parameter in required_params:
                if parameter not in self.config_file_data["required"] or self.config_file_data["required"][parameter] == "":
                    raise Exception(f"Required Parameter: {parameter} for Platform: {self.platform_name} not defined!")
        else:
            raise Exception(f"Required Config for Platform: {self.platform_name} not defined!")
